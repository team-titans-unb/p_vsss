...
import os
import ctypes as ct
from communication.sims.simConst import *
...
c_GetObjectQuaternion = ct.CFUNCTYPE(
    ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_float), ct.c_int32
)(("simxGetObjectQuaternion", libsimx))
...
c_SetObjectQuaternion = ct.CFUNCTYPE(
    ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_float), ct.c_int32
)(("simxSetObjectQuaternion", libsimx))
...
c_GetArrayParam = ct.CFUNCTYPE(
    ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_float), ct.c_int32
)(("simxGetArrayParam", libsimx))
c_SetArrayParam = ct.CFUNCTYPE(
    ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_float), ct.c_int32
)(("simxSetArrayParam", libsimx))
c_GetBoolParam = ct.CFUNCTYPE(
    ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_ubyte), ct.c_int32
)(("simxGetBoolParam", libsimx))
c_SetBoolParam = ct.CFUNCTYPE(
    ct.c_int32, ct.c_int32, ct.c_int32, ct.c_ubyte, ct.c_int32
)(("simxSetBoolParam", libsimx))
c_GetInt32Param = ct.CFUNCTYPE(
    ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_int32), ct.c_int32
)(("simxGetInt32Param", libsimx))
c_SetInt32Param = ct.CFUNCTYPE(
    ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32
)(("simxSetInt32Param", libsimx))
c_GetFloatParam = ct.CFUNCTYPE(
    ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_float), ct.c_int32
)(("simxGetFloatParam", libsimx))
c_SetFloatParam = ct.CFUNCTYPE(
    ct.c_int32, ct.c_int32, ct.c_int32, ct.c_float, ct.c_int32
)(("simxSetFloatParam", libsimx))
c_GetStringParam = ct.CFUNCTYPE(
    ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.POINTER(ct.c_char)), ct.c_int32
)(("simxGetStringParam", libsimx))
...
c_CheckCollision = ct.CFUNCTYPE(
    ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_ubyte), ct.c_int32
)(("simxCheckCollision", libsimx))
c_CheckDistance = ct.CFUNCTYPE(
    ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_float), ct.c_int32
)(("simxCheckDistance", libsimx))
...
c_ClearInt32Signal = ct.CFUNCTYPE(
    ct.c_int32, ct.c_int32, ct.POINTER(ct.c_char), ct.c_int32
)(("simxClearInt32Signal", libsimx))
...
c_GetInt32Signal = ct.CFUNCTYPE(
    ct.c_int32, ct.c_int32, ct.POINTER(ct.c_char), ct.POINTER(ct.c_int32), ct.c_int32
)(("simxGetInt32Signal", libsimx))
...
c_GetObjectFloatParam = ct.CFUNCTYPE(
    ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_float), ct.c_int32
)(("simxGetObjectFloatParam", libsimx))
c_SetObjectFloatParam = ct.CFUNCTYPE(
    ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32, ct.c_float, ct.c_int32
)(("simxSetObjectFloatParam", libsimx))
c_GetObjectInt32Param = ct.CFUNCTYPE(
    ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_int32), ct.c_int32
)(("simxGetObjectInt32Param", libsimx))
c_SetObjectInt32Param = ct.CFUNCTYPE(
    ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32
)(("simxSetObjectInt32Param", libsimx))
